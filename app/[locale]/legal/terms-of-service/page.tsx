...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Service for Mohamad Reza Reziyanto's Portfolio App regarding TikTok API usage",
      ...
      <div className="mt-8 space-y-8 leading-relaxed text-neutral-700 dark:text-neutral-300">
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            {process.env.NEXT_PUBLIC_AUTHOR_NAME}&apos;s professional projects,
            technical skills, and social media presence through integrated API
            services.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            the property of Mohamad Reza Reziyanto. Content displayed through the TikTok
