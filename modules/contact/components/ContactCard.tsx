...
const ContactCard = ({
  ...
  return (
    <SpotlightCard
      className={`relative grid w-full grid-cols-[1fr_auto] overflow-hidden rounded-md border-2 border-neutral-300 p-4 sm:grid-cols-[2.5fr_1fr] sm:p-6 dark:border-neutral-700 ${colSpan} ${backgroundGradientColor}`}
    >
