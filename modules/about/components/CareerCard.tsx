...
const CareerCard = ({
  ...
  const currentResponsibilities = responsibilities ? responsibilities[locale as "en" | "id"] : [];
  const currentLessons = lessons_learned ? lessons_learned[locale as "en" | "id"] : [];
  const currentImpact = impact ? impact[locale as "en" | "id"] : [];
                    ...
                    {currentResponsibilities.length > 0 && (
                      <div className="space-y-2">
                        ...
                        <ul className="space-y-1 text-xs leading-relaxed opacity-90">
                          {currentResponsibilities.map((item, index) => (
