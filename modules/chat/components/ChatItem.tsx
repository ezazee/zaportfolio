    ...
    >
      ...
      >
        ...
        >
          ...
          {condition && (
            <div className="flex items-center gap-[2px] rounded-full border border-accent bg-neutral-800 px-1.5 py-0.5 font-medium text-accent">
              <AuthorIcon size={13} />
        ...
        >
          <div
            className={clsx(
              ...
              condition &&
                "rounded-tl-xl rounded-tr-sm bg-primary text-white group-hover:bg-primary-700 dark:bg-accent dark:!text-dark dark:group-hover:bg-yellow-300",
            )}
          >
            {is_reply && (
              <>
                <span
                  className={clsx(
                    ...
                    condition && "!text-dark font-bold dark:text-dark",
                  )}
                >
                  @{reply_to}{" "}
                </span>
