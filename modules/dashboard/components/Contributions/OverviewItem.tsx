...
const OverviewItem = ({ label, value, unit = "" }: OverviewItemProps) => (
  <SpotlightCard className="flex flex-col bg-neutral-100 dark:bg-neutral-800 p-4 text-center">
    <span className="text-sm dark:text-neutral-400">{label}</span>
    <div>
      <AnimateCounter
        className="text-xl font-medium text-primary dark:text-neutral-100 lg:text-2xl"
        total={value}
      />
